...
window.gaIdList = <?= json_encode($opt_out_ids) ?>;
  ...
  public static function enqueueScriptsFirstHead() {
    ...
    wp_localize_script(Plugin::PREFIX . '-google_analytics_opt_out', 'core_standards_opt_out_cookie_domain', '.' . ltrim(COOKIE_DOMAIN, '.'));
  }
  ...
  public static function wp_enqueue_scripts() {
    ...
    wp_localize_script(Plugin::PREFIX . '-enable-opt_out', 'core_standards_opt_out_confirmation_message', __('Google Analytics tracking has been disabled.', Plugin::L10N));
  }
